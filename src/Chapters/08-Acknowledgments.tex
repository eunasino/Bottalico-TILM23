...
Nomi e cognomi sono futili in un elenco di emozioni.\\
Ringraziamenti speciali vanno a mia madre, a Noemi e a Pizio. Le mie icone principali, la mia forza, le persone che in assoluto mi hanno sostenuto e riempito di amore dal giorno 0, le persone che mi hanno trasmesso l'importanza di valori fondamentali, le persone che mi rendono quello che sono.\\
Ringrazio l'affetto speciale e la comprensione della mia famiglia, che mi ha sempre cullato nel bene e nel male.\\
Ringrazio i miei amici, per le energie a me dedicate e per la loro sana sincerità.\\
Ringrazio i miei docenti e colleghi, per la pazienza e il sostegno.\\
Ringrazio lo staff di Enzo e Ciro, che mi ha sempre supportato e sopportato.\\
Ringrazio la musica, per aver sempre saputo cosa dirmi anche quando non mi diceva nulla, per avermi reso capace di sentire e non solo ascoltare, per aver ispirato il mio percorso e le mie scelte, per avermi guidato nei sentieri occultati dalla nebbia perlacea delle incertezze.\\
Questo paragrafo, quello dei ringraziamenti, è l'unico che non ho riletto nel corso della stesura di questo testo(se non per mettere le maiuscole).\\
A  buon intenditor...
