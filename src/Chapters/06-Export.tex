...
In order to explain this chapter in the clearest way, in the following section i will make a \textbf{work report} of the operation I made since the idea was born throught it's realization

\section{Work report}

	\begin{enumerate}
		\item \textbf{the idea} This project inevitably had a different form at the moment of idealization. Exploring my possibilities and working on the technical aspect, my work gradually took form and became part of our dimension. I'm not able to say which of the two versions is better, but the \textbf{realization} of a work is always painted with different colors than it's \textbf{idealization}
		
		\item \textbf{material preparation} Once i had the foundamental idea, i started finding the best material for it's realization, so I made choises about:
			
			\begin{compactitem}
				\item languages, softwares and middleware
				\item open-source game
				\item compositional character of the implementation
			\end{compactitem}
		So I initialized the Wwise project and was ready for the next step
		
		\item \textbf{composition} I sterted writing codes and generating acousmatic gestures thinking about their role in the audio implementation.
		Once the gestures mad for the main actions of the game were prepared, I started working on 
		
		\item \textbf{Audio implementation} I started uploading the audio files that I generated during the composition, getting an idea of ​​how to interpolate them and which parameters to modify and how to modify them.
		This operation was very important to evaluating the quality of my compositional process. Recomposing some gestures and idealizing the character that the missing gestures should have had to complete the implementation in the best way to reach my goal.
