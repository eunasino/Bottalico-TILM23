...
\begin{compactitem}
	\item Steve Horowitz and Scott Looney - The essential guide to game audio (the theory and pratice of sound for games)
	\item Audiokinetic Cube Integration
\end{compactitem}

\paragraph{Sitography}
\begin{compactitem}
	\item https://www.audiokinetic.com/en/help/
	\item https://it.wikipedia.org/wiki/Gamification
\end{compactitem}
